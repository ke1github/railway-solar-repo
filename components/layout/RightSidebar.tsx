    ...
    <>
      ...
      <div className="fixed top-4 right-4 z-50 lg:hidden">
        <button
          ...
          className="p-2 rounded-md bg-background/90 backdrop-blur-sm text-foreground shadow-sm"
        >
      ...
      <aside
        className={cn(
          "fixed inset-y-0 right-0 z-40 w-64 bg-background/95 backdrop-blur-sm shadow-sm transition-transform lg:translate-x-0",
          isOpen ? "translate-x-0" : "translate-x-full lg:translate-x-0",
          className
        )}
      >
        <div className="flex flex-col h-full">
          <div className="py-5 px-4 mb-4 flex items-center justify-between bg-gradient-to-l from-primary/10 to-transparent">
          ...
          <div className="flex-1 overflow-y-auto px-4">
            {notifications.map((notification) => {
              ...
              return (
                <div
                  key={notification.id}
                  className="mb-4 p-3 rounded-lg bg-background-subtle/50 hover:bg-background-subtle transition-colors duration-200 cursor-pointer shadow-sm"
                >
          ...
          <div className="px-4 pb-4">
            <Card className="bg-background-subtle/80 shadow-sm overflow-hidden">
